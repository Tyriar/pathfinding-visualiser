...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['core', 'canvas-helper', 'fibonacci-heap', 'map-node', 'dijkstra-common'], factory);
    ...
    root.dijkstraFibonacciHeap = factory(core, canvasHelper, FibonacciHeap, MapNode, aStarCommon);
  }
}(this, function (core, canvasHelper, FibonacciHeap, MapNode, dijkstraCommon) {
  'use strict';
