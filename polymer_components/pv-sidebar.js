Polymer('pv-sidebar', {
  ...
  run: function () {
    if (this.publish.runHandler) this.publish.runHandler();
  },
  generate: function () {
    if (this.publish.generateHandler) this.publish.generateHandler();
  },
  clear: function () {
    if (this.publish.clearHandler) this.publish.clearHandler();
  }
});
